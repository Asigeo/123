...
class LogicaZona:
    ...
    def __init__(self, zona):
        ...
        # seguridades
        self.inv_tmax_agua = seguridades["inv_tmax_agua" + str(self.zona)]
        self.inv_tmax_suelo = seguridades["inv_tmax_suelo" + str(self.zona)]
        self.inv_tmin_suelo = seguridades["inv_tmin_suelo" + str(self.zona)]
        self.ver_tmin_agua = seguridades["ver_tmin_agua" + str(self.zona)]
        self.ver_tmin_suelo = seguridades["ver_tmin_suelo" + str(self.zona)]
        self.ant_tmax_agua = seguridades["ant_tmax_agua" + str(self.zona)]
        self.ant_tmin_agua = seguridades["ant_tmin_agua" + str(self.zona)]
        self.ant_tmin_suelo = seguridades["ant_tmin_suelo" + str(self.zona)]
